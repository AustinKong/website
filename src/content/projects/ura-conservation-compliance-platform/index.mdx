...
import StackedCarousel from '../../../components/shared/StackedCarousel.astro';
...
<StackedCarousel
	images={[
		{
			src: homePage,
			alt: 'Map view of conserved buildings in the building repository',
			caption: 'Building repository and map',
		},
		{
			src: facadeDetectionPage,
			alt: 'Facade crop interface with automatic facade detection',
			caption: 'Facade detection and cropping',
		},
		{
			src: comparisonPage,
			alt: 'Historical and current facade images with detected elements',
			caption: 'Side-by-side facade comparison',
		},
		{
			src: reportPage,
			alt: 'Generated report with an executive summary and change analysis',
			caption: 'Editable conservation report',
		},
	]}
/>
...
<StackedCarousel
	images={[
		{
			src: slide1,
			alt: 'Generated conservation compliance report title slide',
			caption: 'Generated presentation',
		},
		{
			src: slide2,
			alt: 'Generated slide showing visual change analysis',
			caption: 'Generated presentation',
		},
		{
			src: slide3,
			alt: 'Generated slide explaining a non-compliant window removal',
			caption: 'Generated presentation',
		},
		{
			src: slide4,
			alt: 'Generated slide listing recommended actions',
			caption: 'Generated presentation',
		},
	]}
/>
